...
test('isStagingDeployment and production-base-url detection work together', () => {
  assert.equal(isStagingDeployment({ VERCEL_ENV: 'preview' }), true)
  assert.equal(isStagingDeployment({ NEXT_PUBLIC_APP_URL: 'https://staging.example.com' }), true)
