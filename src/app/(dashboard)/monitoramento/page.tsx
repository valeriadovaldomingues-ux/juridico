      ...
      <div className="internal-page max-w-3xl">
        <div className="relative overflow-hidden rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] px-5 py-5 sm:px-7 sm:py-6 shadow-[0_18px_48px_rgba(13,34,53,0.06)] mb-6">
          ...
          <div className="relative">
            ...
            <p className="text-[13px] text-[var(--color-ink-3)] mt-2">Busca automática de publicações e prazos</p>
          </div>
        </div>
        <div className="bg-[var(--color-surface)] rounded-2xl border border-[var(--color-border)] shadow-[0_12px_36px_rgba(13,34,53,0.05)] p-8">
          ...
          <h2 className="text-[16px] font-semibold text-[var(--color-ink)] mb-2">Ative o módulo de Monitoramento</h2>
          <p className="text-[13px] text-[var(--color-ink-2)] leading-relaxed mb-2">
            Tabela <code className="font-mono text-[12px] bg-[var(--color-surface-warm)] border border-[var(--color-border)] px-1.5 py-0.5 rounded">{missingTable}</code> não encontrada.
            Execute os arquivos SQL no <strong>SQL Editor</strong> do Supabase, nesta ordem:
          </p>
          <ol className="list-decimal list-inside space-y-1.5 text-[13px] text-[var(--color-ink-2)] mb-4">
