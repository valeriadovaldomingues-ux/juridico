...
describe('GET /api/processos/busca', () => {
  ...
  it('retorna vazio quando a busca não tem mínimo de caracteres', async () => {
    ...
    const res = await GET({ nextUrl: new URL('http://localhost/api/processos/busca?q=a') } as any)
