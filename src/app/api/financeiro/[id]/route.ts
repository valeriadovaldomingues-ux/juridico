...
export async function PUT(
  ...
  if (auth.role === 'administrativo') {
    ...
    if (!atual || !podeGerenciarLancamentoDespesa(auth.userId, auth.role, atual.tipo)
      || !podeGerenciarLancamentoDespesa(auth.userId, auth.role, body.tipo)) {
